...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SavedSearchesListWidgetBlock'
        db.create_table(u'myblocks_savedsearcheslistwidgetblock', (
            (u'block_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['myblocks.Block'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'myblocks', ['SavedSearchesListWidgetBlock'])


    def backwards(self, orm):
        # Deleting model 'SavedSearchesListWidgetBlock'
        db.delete_table(u'myblocks_savedsearcheslistwidgetblock')
    ...
    models = {
        ...
        u'myblocks.savedsearcheslistwidgetblock': {
            'Meta': {'object_name': 'SavedSearchesListWidgetBlock', '_ormbases': [u'myblocks.Block']},
            u'block_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['myblocks.Block']", 'unique': 'True', 'primary_key': 'True'})
        },
