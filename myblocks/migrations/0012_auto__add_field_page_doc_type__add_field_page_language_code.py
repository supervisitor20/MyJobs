...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Page.doc_type'
        db.add_column(u'myblocks_page', 'doc_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'Page.language_code'
        db.add_column(u'myblocks_page', 'language_code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=16),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Page.doc_type'
        db.delete_column(u'myblocks_page', 'doc_type')

        # Deleting field 'Page.language_code'
        db.delete_column(u'myblocks_page', 'language_code')
