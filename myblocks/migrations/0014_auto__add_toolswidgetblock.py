...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ToolsWidgetBlock'
        db.create_table(u'myblocks_toolswidgetblock', (
            (u'block_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['myblocks.Block'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'myblocks', ['ToolsWidgetBlock'])


    def backwards(self, orm):
        # Deleting model 'ToolsWidgetBlock'
        db.delete_table(u'myblocks_toolswidgetblock')
    ...
    models = {
        ...
        u'myblocks.savedsearcheslistwidgetblock': {
            'Meta': {'object_name': 'SavedSearchesListWidgetBlock'},
            u'block_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['myblocks.Block']", 'unique': 'True', 'primary_key': 'True'})
        },
        u'myblocks.savedsearchwidgetblock': {
            'Meta': {'object_name': 'SavedSearchWidgetBlock'},
            u'block_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['myblocks.Block']", 'unique': 'True', 'primary_key': 'True'})
        },
        ...
        u'myblocks.toolswidgetblock': {
            'Meta': {'object_name': 'ToolsWidgetBlock'},
            u'block_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['myblocks.Block']", 'unique': 'True', 'primary_key': 'True'})
        },
