...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SeoSite.parent_site'
        db.alter_column(u'seo_seosite', 'parent_site_id', self.gf('seo.models.NonChainedForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['seo.SeoSite']))

    def backwards(self, orm):

        # Changing field 'SeoSite.parent_site'
        db.alter_column(u'seo_seosite', 'parent_site_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['seo.SeoSite'], on_delete=models.SET_NULL))
