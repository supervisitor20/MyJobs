...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Configuration.browse_facet_show_4'
        db.add_column(u'seo_configuration', 'browse_facet_show_4',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Configuration.browse_facet_text_4'
        db.add_column(u'seo_configuration', 'browse_facet_text_4',
                      self.gf('django.db.models.fields.CharField')(default='Job Profiles', max_length=50),
                      keep_default=False)

        # Adding field 'Configuration.browse_facet_order_4'
        db.add_column(u'seo_configuration', 'browse_facet_order_4',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Configuration.browse_facet_show_4'
        db.delete_column(u'seo_configuration', 'browse_facet_show_4')

        # Deleting field 'Configuration.browse_facet_text_4'
        db.delete_column(u'seo_configuration', 'browse_facet_text_4')

        # Deleting field 'Configuration.browse_facet_order_4'
        db.delete_column(u'seo_configuration', 'browse_facet_order_4')
    ...
    models = {
        ...
        u'seo.configuration': {
            ...
            'browse_facet_order_4': ('django.db.models.fields.IntegerField', [], {'default': '2'}),
