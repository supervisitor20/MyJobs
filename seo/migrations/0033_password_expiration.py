...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Company.password_expiration'
        db.add_column(u'seo_company', 'password_expiration',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Company.password_expiration'
        db.delete_column(u'seo_company', 'password_expiration')
