...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Configuration.use_secure_blocks'
        db.add_column(u'seo_configuration', 'use_secure_blocks',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Configuration.use_secure_blocks'
        db.delete_column(u'seo_configuration', 'use_secure_blocks')
