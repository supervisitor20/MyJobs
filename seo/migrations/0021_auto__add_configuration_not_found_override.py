...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field not_found_override on 'Configuration'
        m2m_table_name = db.shorten_name(u'seo_configuration_not_found_override')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('configuration', models.ForeignKey(orm[u'seo.configuration'], null=False)),
            ('redirect', models.ForeignKey(orm[u'redirects.redirect'], null=False))
        ))
        db.create_unique(m2m_table_name, ['configuration_id', 'redirect_id'])


    def backwards(self, orm):
        # Removing M2M table for field not_found_override on 'Configuration'
        db.delete_table(db.shorten_name(u'seo_configuration_not_found_override'))
