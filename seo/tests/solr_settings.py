...
SOLR_FIXTURE = [
    ...
    },
    {
        ...
        'company_slab_exact': 'acme/careers::Acme',
        'country': 'United States',
        'country_ac': 'United States',
        'country_exact': 'United States',
        'country_short': 'USA',
...
DUBAI_FIXTURE = [
    {
        ...
        'city_ac': 'Dubai',
        'city_exact': 'Dubai',
        'city_slab': 'dubai/None/are/jobs::Dubai, ARE',
        'city_slab_exact': 'dubai/None/are/jobs::Dubai, ARE',
        'city_slug': 'dubai',
        'company': 'Acme',
        'company_ac': 'Acme',
        'company_exact': 'Acme',
        ...
        'country_ac': 'United Arab Emirates',
        'country_exact': 'United Arab Emirates',
        'country_short': 'ARE',
        'country_short_exact': 'ARE',
        'country_slab': 'are/jobs::United Arab Emirates',
        'country_slab_exact': 'are/jobs::United Arab Emirates',
        ...
        'django_ct': 'seo.joblisting',
        'django_id': 2,
        'full_loc': 'city::Indianapolis@@state::None@@location::Dubai@@country::United Arab Emirates',
        'full_loc_exact': 'city::Indianapolis@@state::None@@location::Dubai@@country::United Arab Emirates',
        'guid': '3'*32,
        'id': 'seo.joblisting.3',
        'is_posted': False,
        'location': 'Dubai, ARE',
        'location_exact': 'Dubai, ARE',
        'onet': 100,
        'onet_exact': 100,
        'on_sites': [0],
        'reqid': 'AAA000002',
        ...
        'state_short': '',
        'state_short_exact': '',
        'state_slab': 'None/are/jobs::None',
        'state_slab_exact': 'None/are/jobs::None',
        'state_slug': '',
        'text': 'témp',
        'title': 'Retail Associate',
        'title_ac': 'Retail Associate',
        'title_exact': 'Retail Associate',
        'title_slab': 'retail-associate/jobs-are::Retail Associate',
        'title_slab_exact': 'retail-associate/jobs-are::Retail Associate',
        'title_slug': 'retail-associate',
        'uid': "1001",
        'link': 'http://my.jobs/EE45273E6D914AED8CB3C9C59D203F4410',
        'lat_long_buid_slab_exact': '-32.202924::-64.404945::0'
