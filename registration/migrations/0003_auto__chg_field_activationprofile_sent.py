...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ActivationProfile.sent'
        db.alter_column(u'registration_activationprofile', 'sent', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'ActivationProfile.sent'
        db.alter_column(u'registration_activationprofile', 'sent', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
    ...
    models = {
        ...
        u'registration.invitation': {
            ...
            'inviting_user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'invites_sent'", 'null': 'True', 'to': u"orm['myjobs.User']"})
        },
        u'seo.atssourcecode': {
