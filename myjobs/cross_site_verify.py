...
def cross_site_verify(fn):
    """Decorator for use with cross site verified APIs. In the event of a request, this function verifies that the host
    site is a parent of the origin (calling) site.
