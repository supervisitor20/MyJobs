...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SecondPartyAccessRequest'
        db.create_table(u'myjobs_secondpartyaccessrequest', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('account_owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='access_requested_by', null=True, on_delete=models.SET_NULL, to=orm['myjobs.User'])),
            ('account_owner_email', self.gf('django.db.models.fields.EmailField')(max_length=255, db_index=True)),
            ('second_party', self.gf('django.db.models.fields.related.ForeignKey')(related_name='access_requested_for', null=True, on_delete=models.SET_NULL, to=orm['myjobs.User'])),
            ('second_party_email', self.gf('django.db.models.fields.EmailField')(max_length=255, db_index=True)),
            ('submitted', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('acted_on', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, db_index=True)),
    ...
    def backwards(self, orm):
        # Deleting model 'SecondPartyAccessRequest'
        db.delete_table(u'myjobs_secondpartyaccessrequest')
    ...
    models = {
        ...
        u'myjobs.secondpartyaccessrequest': {
            ...
            'account_owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'access_requested_by'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['myjobs.User']"}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'second_party': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'access_requested_for'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['myjobs.User']"}),
