...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'myjobs_secondpartyaccessrequest', (
            ...
            ('account_owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, on_delete=models.SET_NULL, to=orm['myjobs.User'])),
            ('account_owner_email', self.gf('django.db.models.fields.EmailField')(max_length=255, db_index=True)),
            ('second_party', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, on_delete=models.SET_NULL, to=orm['myjobs.User'])),
