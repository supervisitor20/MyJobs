...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        orm.AppAccess.objects.bulk_create([
            # Used to post new jobs
            orm.AppAccess(name="Posting"),
            # used to sell products (job listings, ad space, etc)
            orm.AppAccess(name="MarketPlace")])
