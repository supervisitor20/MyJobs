...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        (update_partner, delete_partner,
         create_pss) = orm.Activity.objects.filter(pk__in=[ 7, 8, 13])

        update_partner.description = 'Edit existing partners.'
        delete_partner.description = 'Remove existing partners.'
        create_pss.description = 'Add new partner saved searches.'
