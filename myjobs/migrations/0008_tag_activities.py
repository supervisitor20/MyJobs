...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """Add activities for Tags."""

        app = orm.AppAccess.objects.get(name="PRM")
        ...
        activities = orm.Activity.objects.filter(name__icontains="tag")

        # update admin roles; signals aren't sent during migrations
        roles = orm.Role.objects.filter(name="Admin")
    ...
    def backwards(self, orm):
        ...
        orm.Activity.objects.filter(
            app_access__name='PRM', description__icontains="tags.").delete()
