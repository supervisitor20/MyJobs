...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ReportPresentation.configuration'
        db.delete_column(u'myreports_reportpresentation', 'configuration_id')

        # Adding field 'ReportTypeDataTypes.configuration'
        db.add_column(u'myreports_reporttypedatatypes', 'configuration',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['myreports.Configuration'], null=True),
                      keep_default=False)

        # Deleting field 'DynamicReport.report_presentation'
        db.delete_column(u'myreports_dynamicreport', 'report_presentation_id')

        # Adding field 'DynamicReport.report_data'
        db.add_column(u'myreports_dynamicreport', 'report_data',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['myreports.ReportTypeDataTypes'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'myreports_reportpresentation', 'configuration',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['myreports.Configuration']),
                      keep_default=False)

        # Deleting field 'ReportTypeDataTypes.configuration'
        db.delete_column(u'myreports_reporttypedatatypes', 'configuration_id')
        ...
        db.add_column(u'myreports_dynamicreport', 'report_presentation',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['myreports.ReportPresentation']),
                      keep_default=False)

        # Deleting field 'DynamicReport.report_data'
        db.delete_column(u'myreports_dynamicreport', 'report_data_id')
