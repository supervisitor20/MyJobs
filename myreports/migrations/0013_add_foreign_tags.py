...
class Migration(DataMigration):
    ...
    def backwards(self, orm):
        ...
        (config_contacts.configurationcolumn_set
            .filter(column_name='partner_tags').delete())
        (config_commrecs.configurationcolumn_set
            .filter(column_name='partner_tags').delete())
        (config_commrecs.configurationcolumn_set
            .filter(column_name='contact_tags').delete())
