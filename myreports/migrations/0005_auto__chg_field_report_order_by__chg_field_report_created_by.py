...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Report.order_by'
        db.alter_column(u'myreports_report', 'order_by', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Report.created_by'
        db.alter_column(u'myreports_report', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['myjobs.User'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'Report.order_by'
        db.alter_column(u'myreports_report', 'order_by', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Report.created_by'
        db.alter_column(u'myreports_report', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['myjobs.User']))
