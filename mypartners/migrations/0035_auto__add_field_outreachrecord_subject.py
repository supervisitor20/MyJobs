...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OutreachRecord.subject'
        db.add_column(u'mypartners_outreachrecord', 'subject',
                      self.gf('django.db.models.fields.TextField')(default='Outreach Record Subject'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OutreachRecord.subject'
        db.delete_column(u'mypartners_outreachrecord', 'subject')
