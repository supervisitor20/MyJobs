...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContactLogEntry.impersonator'
        db.add_column(u'mypartners_contactlogentry', 'impersonator',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='impersonator', null=True, on_delete=models.SET_NULL, to=orm['myjobs.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContactLogEntry.impersonator'
        db.delete_column(u'mypartners_contactlogentry', 'impersonator_id')
