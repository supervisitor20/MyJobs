...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'OutreachWorkflowState', fields ['state']
        db.create_unique(u'mypartners_outreachworkflowstate', ['state'])
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'OutreachWorkflowState', fields ['state']
        db.delete_unique(u'mypartners_outreachworkflowstate', ['state'])
