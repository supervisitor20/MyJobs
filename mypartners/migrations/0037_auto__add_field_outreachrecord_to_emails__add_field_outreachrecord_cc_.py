...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OutreachRecord.to_emails'
        db.add_column(u'mypartners_outreachrecord', 'to_emails',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'OutreachRecord.cc_emails'
        db.add_column(u'mypartners_outreachrecord', 'cc_emails',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OutreachRecord.to_emails'
        db.delete_column(u'mypartners_outreachrecord', 'to_emails')

        # Deleting field 'OutreachRecord.cc_emails'
        db.delete_column(u'mypartners_outreachrecord', 'cc_emails')
    ...
    models = {
        ...
        u'mypartners.outreachrecord': {
            ...
            'cc_emails': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            ...
            'to_emails': ('django.db.models.fields.TextField', [], {'blank': 'True'})
        },
        u'mypartners.outreachworkflowstate': {
            'Meta': {'object_name': 'OutreachWorkflowState'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'state': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '50'})
        },
