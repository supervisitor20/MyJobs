...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'mypartners_contactrecord', 'created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Tag.created_on'
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Tag.created_on'
        db.alter_column(u'mypartners_tag', 'created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
