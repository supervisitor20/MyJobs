...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'OutreachRecord'
        db.create_table(u'mypartners_outreachrecord', (
        ...
        db.send_create_signal(u'mypartners', ['OutreachRecord'])

        # Adding M2M table for field partners on 'OutreachRecord'
        m2m_table_name = db.shorten_name(u'mypartners_outreachrecord_partners')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('outreachrecord', models.ForeignKey(orm[u'mypartners.outreachrecord'], null=False)),
            ('partner', models.ForeignKey(orm[u'mypartners.partner'], null=False))
        ))
        db.create_unique(m2m_table_name, ['outreachrecord_id', 'partner_id'])

        # Adding M2M table for field contacts on 'OutreachRecord'
        m2m_table_name = db.shorten_name(u'mypartners_outreachrecord_contacts')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('outreachrecord', models.ForeignKey(orm[u'mypartners.outreachrecord'], null=False)),
            ('contact', models.ForeignKey(orm[u'mypartners.contact'], null=False))
        ))
        db.create_unique(m2m_table_name, ['outreachrecord_id', 'contact_id'])

        # Adding M2M table for field communication_records on 'OutreachRecord'
        m2m_table_name = db.shorten_name(u'mypartners_outreachrecord_communication_records')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('outreachrecord', models.ForeignKey(orm[u'mypartners.outreachrecord'], null=False)),
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'OutreachRecord'
        db.delete_table(u'mypartners_outreachrecord')

        # Removing M2M table for field partners on 'OutreachRecord'
        db.delete_table(db.shorten_name(u'mypartners_outreachrecord_partners'))

        # Removing M2M table for field contacts on 'OutreachRecord'
        db.delete_table(db.shorten_name(u'mypartners_outreachrecord_contacts'))
