...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'mypartners_partner', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['seo.Company'], null=True, on_delete=models.SET_NULL))

        # Changing field 'Contact.partner'
        db.alter_column(u'mypartners_contact', 'partner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mypartners.Partner'], null=True, on_delete=models.SET_NULL))

        # Changing field 'ContactRecord.contact'
        db.alter_column(u'mypartners_contactrecord', 'contact_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mypartners.Contact'], null=True, on_delete=models.SET_NULL))

        # Changing field 'ContactRecord.partner'
        db.alter_column(u'mypartners_contactrecord', 'partner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mypartners.Partner'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'Partner.owner'
        db.alter_column(u'mypartners_partner', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['seo.Company']))

        # Changing field 'Contact.partner'
        db.alter_column(u'mypartners_contact', 'partner_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['mypartners.Partner']))

        # Changing field 'ContactRecord.contact'
        db.alter_column(u'mypartners_contactrecord', 'contact_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mypartners.Contact'], null=True))

        # Changing field 'ContactRecord.partner'
        db.alter_column(u'mypartners_contactrecord', 'partner_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['mypartners.Partner']))
