...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SavedSearch.text_only'
        db.add_column(u'mysearches_savedsearch', 'text_only',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SavedSearch.text_only'
        db.delete_column(u'mysearches_savedsearch', 'text_only')
    ...
    models = {
        ...
        u'mysearches.savedsearch': {
            ...
            'text_only': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
