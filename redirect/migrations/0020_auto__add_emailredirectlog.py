...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EmailRedirectLog'
        db.create_table(u'redirect_emailredirectlog', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('from_addr', self.gf('django.db.models.fields.EmailField')(max_length=75)),
            ('to_guid', self.gf('django.db.models.fields.CharField')(max_length=38)),
            ('buid', self.gf('django.db.models.fields.IntegerField')()),
            ('to_addr', self.gf('django.db.models.fields.EmailField')(max_length=75, blank=True)),
            ('sent', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'redirect', ['EmailRedirectLog'])


    def backwards(self, orm):
        # Deleting model 'EmailRedirectLog'
        db.delete_table(u'redirect_emailredirectlog')
    ...
    models = {
        ...
        u'redirect.emailredirectlog': {
            ...
            'to_addr': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'blank': 'True'}),
