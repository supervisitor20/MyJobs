...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ViewSource.view_source_type'
        db.add_column(u'redirect_viewsource', 'view_source_type',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ViewSource.view_source_type'
        db.delete_column(u'redirect_viewsource', 'view_source_type')
    ...
    models = {
        ...
        u'redirect.viewsource': {
            ...
            'view_source_type': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
