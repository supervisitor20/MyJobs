...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CustomExcludedViewSource'
        db.create_table(u'redirect_customexcludedviewsource', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('buid', self.gf('django.db.models.fields.IntegerField')()),
            ('view_source', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'redirect', ['CustomExcludedViewSource'])

        # Adding unique constraint on 'CustomExcludedViewSource', fields ['buid', 'view_source']
        db.create_unique(u'redirect_customexcludedviewsource', ['buid', 'view_source'])

    def backwards(self, orm):
        # Removing unique constraint on 'CustomExcludedViewSource', fields ['buid', 'view_source']
        db.delete_unique(u'redirect_customexcludedviewsource', ['buid', 'view_source'])

        # Deleting model 'CustomExcludedViewSource'
        db.delete_table(u'redirect_customexcludedviewsource')
