...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        call_command("loaddata", "redirect/migrations/excluded_view_sources.json")
    ...
    models = {
        ...
        u'redirect.excludedviewsource': {
            ...
            'view_source': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['redirect.ViewSource']", 'primary_key': 'True'})
        },
        u'redirect.redirect': {
