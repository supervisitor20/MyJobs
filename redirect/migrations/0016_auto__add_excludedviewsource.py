...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExcludedViewSource'
        db.create_table(u'redirect_excludedviewsource', (
            ('view_source', self.gf('django.db.models.fields.IntegerField')(primary_key=True)),
        ))
        db.send_create_signal(u'redirect', ['ExcludedViewSource'])


    def backwards(self, orm):
        # Deleting model 'ExcludedViewSource'
        db.delete_table(u'redirect_excludedviewsource')
