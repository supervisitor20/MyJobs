...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'redirect_redirect', 'guid', self.gf('django.db.models.fields.CharField')(max_length=38, primary_key=True))

    def backwards(self, orm):

        # Changing field 'Redirect.guid'
        db.alter_column(u'redirect_redirect', 'guid', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True))
